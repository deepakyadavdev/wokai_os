...
const DEMO_ACTIVITY: ActivityItem[] = [
  {
    ...
    detail: 'Meeting with Investor — Tomorrow 4:00 PM',
    category: 'calendar',
    time: new Date(Date.now() - 2 * 60e3).toISOString(),
    source: 'Investor Sync',
  },
  {
    id: 'da2',
    icon: 'Mail',
    color: 'blue',
    label: 'Email Drafted',
    detail: 'Subject: Pitch Deck feedback',
    category: 'email',
  ...
  },
  {
    ...
    detail: 'Pitch Deck — 3 tasks, estimated 3.5 hours',
    category: 'tasks',
  ...
  },
  {
    ...
    color: 'green',
    label: 'Call Logged',
    detail: 'Called Broadband Support — billing query resolved',
    category: 'calls',
  ...
  },
  {
    ...
    detail: 'Focus block added: 8 PM — 10 PM',
    category: 'calendar',
  ...
  },
  {
    ...
    detail: 'Review market slide — marked done',
    category: 'tasks',
